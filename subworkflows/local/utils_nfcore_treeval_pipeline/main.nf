//
// Subworkflow with functionality specific to the sanger-tol/treeval pipeline
//
...
workflow PIPELINE_INITIALISATION {
    ...
    _split_telomere     // boolean: Split telomere scaffolds into 3p and 5p
    _run_hires         // boolean: Generate high resolution pretext maps
    _run_ultra         // boolean: Generate ultra high resolution pretext maps
