...
include { PRETEXT_GRAPH as PRETEXT_INGEST_SNDRD           } from '../../subworkflows/local/pretext_graph'
include { PRETEXT_GRAPH as PRETEXT_INGEST_HIRES           } from '../../subworkflows/local/pretext_graph'
