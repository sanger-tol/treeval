...
Finally Zero read depth, Maximum read depth and half read depth list are generated by [GETMINMAXPUNCHES](../modules/local/getminmaxpunches) and [FINDHALFCOVERAGE](../modules/local/findhalfcoverage) respectively.
