...
![An example Hi-C map viewed in PretextViewer. Each image each of the tracks generated by TreeVal\label{fig:pretext}](./pretext_example.png){{height="9pt"}} 

![A HiGlass Hi-C map of the lepidoptera *Hypothyris semifulva*. Included are the four tracks generated by TreeVal.\label{fig:higlass}](./higlass_example.png){height="9pt"}
