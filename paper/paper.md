...
authors:
  ...
  - name: Shane McCarthy
    affiliation: "1"
affiliations:
 - name: Wellcome Sanger Institute, Wellcome Genome Campus, Hinxton, Cambridgeshire CB10 1SA, UK
   index: 1
 - name:
   index: 2
date: 3 June 2024
...
3. Illumina Hi-C reads files should be in an unmapped CRAM format along side an index (`.cram.crai`) file.
