process CRAM_FILTER_ALIGN_BWAMEM2_FIXMATE_SORT {
    ...
    """
    cram_filter -n ${from}-${to} ${cramfile} - | samtools fastq -F0xB00 -nt - | bwa-mem2 mem -p ${bwaprefix} -t${task.cpus} -5SPCp -H'${rglines}' - | samtools fixmate -mpu - - | samtools sort --write-index -l1 -@${task.cpus} -T ${base}_${chunkid}_sort_tmp -o ${prefix}_${base}_${chunkid}_mem.bam -
